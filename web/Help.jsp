...
<div class="container">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            29(13): i308-i315) called incaRNAtion.<br><br>
            ...
            <ul>
                ...
                <li>
                    ...
                    Allows the user to select a single motif from the structure that will have a greater chance to
            ...
            <ul>
                ...
                <li>
                    ...
                    <h5>Fold Image:</h5>
                    A secondary structure image of the designed sequence and its predicted fold. This image is generated
                    by <a href="http://varna.lri.fr/">VARNA Visualization Applet for RNA</a>
                </li>
            </ul>
            <h3>Run Time</h3>
